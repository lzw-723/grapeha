...
public class HSQLDB {
  ...
  public static Future<JDBCPool> init(Vertx vertx) {
    ...
    String createTableSQL = "CREATE TABLE IF NOT EXISTS Books (" + "id VARCHAR(36) PRIMARY KEY," + "title VARCHAR(255) NOT NULL," + "author VARCHAR(255)," + "date VARCHAR(255)," + "description VARCHAR(511)," + "path VARCHAR(255) NOT NULL," + "last_update VARCHAR(255) NOT NULL);";
    ...
    createTableSQL += "CREATE TABLE IF NOT EXISTS Bookshelves ( id VARCHAR(36) PRIMARY KEY, title VARCHAR(255), description VARCHAR(255), cover VARCHAR(255), path VARCHAR(255));";
